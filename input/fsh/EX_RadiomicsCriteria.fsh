...
* extension[radiomics-criteria-settings].extension[localizationMethod].valueString = "GLOBAL"
...
* extension[radiomics-criteria-settings].extension[discretisationMethod].extension[valueString].valueString = "FBS"
...
* extension[radiomics-criteria-settings].extension[spatialResamplingMethod].valueString = "Bicubic spline"
