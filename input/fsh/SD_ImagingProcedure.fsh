Profile:        ImagingProcedureRadiomics
Parent:         Procedure    
Id:             onco-biological-imagingstudy-procedure
Title:          "Imaging Procedure"
Description:    "Description of an imaging study acquisition procedure"

* extension contains imaging-settings named imaging-settings 1..1
