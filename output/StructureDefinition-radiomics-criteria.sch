...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://fhir.arkhn.com/osiris/StructureDefinition/radiomics-criteria-settings']) &gt;= 1">extension with URL = 'http://fhir.arkhn.com/osiris/StructureDefinition/radiomics-criteria-settings': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.arkhn.com/osiris/StructureDefinition/radiomics-criteria-settings']) &lt;= 1">extension with URL = 'http://fhir.arkhn.com/osiris/StructureDefinition/radiomics-criteria-settings': maximum cardinality of 'extension' is 1</sch:assert>
