...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      <sch:assert test="count(f:extension[@url = 'http://fhir.arkhn.com/osiris/StructureDefinition/numberOfFractions']) &gt;= 1">extension with URL = 'http://fhir.arkhn.com/osiris/StructureDefinition/numberOfFractions': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.arkhn.com/osiris/StructureDefinition/numberOfFractions']) &lt;= 1">extension with URL = 'http://fhir.arkhn.com/osiris/StructureDefinition/numberOfFractions': maximum cardinality of 'extension' is 1</sch:assert>
