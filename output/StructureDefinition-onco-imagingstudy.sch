...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ImagingStudy/f:series">
      <sch:assert test="count(f:extension[@url = 'http://fhir.arkhn.com/osiris/StructureDefinition/series-weightheigt']) &lt;= 1">extension with URL = 'http://fhir.arkhn.com/osiris/StructureDefinition/series-weightheigt': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.arkhn.com/osiris/StructureDefinition/imaging-settings']) &gt;= 1">extension with URL = 'http://fhir.arkhn.com/osiris/StructureDefinition/imaging-settings': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.arkhn.com/osiris/StructureDefinition/imaging-settings']) &lt;= 1">extension with URL = 'http://fhir.arkhn.com/osiris/StructureDefinition/imaging-settings': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:description) &gt;= 1">description: minimum cardinality of 'description' is 1</sch:assert>
